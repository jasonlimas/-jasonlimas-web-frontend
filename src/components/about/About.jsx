...
export default function About() {
  return (
    <div className='about' id='about'>
        ...
        <h1>About Me</h1>
          <p className='pDesc'>
            Hi! I'm Jason. I'm an undergraduate Computer Science student at Deakin University, and I'm also currently working as a full-stack developer at XDC Indonesia. I'm passionate about my work and software engineering in general. I built this website as a form of demonstration of my proficiency in web development.<br></br><br></br>
            I've been coding since 2017 and have built several apps with various programming languages throughout the years. When I started working as a full-stack developer, I built my first major project with the Laravel framework, which made me fall in love with web development. Since then, I've been spending my free time discovering many tech stacks and familiarizing myself more with the fundamentals of modern web apps.<br></br><br></br>
            Outside of work and studies, I love exploring the world of specialty coffee. I like reading books about coffee, learning more about various brew methods and recipes, as well as tasting coffees from different origins.<br></br><br></br>
